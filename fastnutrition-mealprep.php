 ...
 * Description: Full meal-prep ordering system for WooCommerce: meal builder, standalone products, macros, bundles, add-ons, delivery/collection profiles, multi-step Blocks checkout, and kitchen prep management.
 * Version:     1.16.0
...
define( 'FN_MEALPREP_VERSION', '1.16.0' );
